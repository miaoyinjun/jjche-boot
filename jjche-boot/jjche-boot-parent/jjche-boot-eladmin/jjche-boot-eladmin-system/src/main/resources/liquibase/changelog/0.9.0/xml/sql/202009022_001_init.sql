...
INSERT INTO `sys_quartz_job` VALUES (7, 'userTask', '0 51 23 ? * *', b'0', '用户账号过期检查', 'accountExpired', NULL, '用户账号长时间未登录，账号过期', 'admin', '', NULL, b'0', 'admin', 'admin', '2021-01-07 09:12:41', '2021-01-07 09:12:41');
