              ...
              <el-button
                ...
                :disabled="
                  scope.row.isActivated ||
                    !checkPermission(['admin', 'version:edit', 'version:del'])
                "
                size="mini"
                type="success"
                icon="el-icon-check"
...
export default {
  ...
  data() {
    return {
      ...
      queryTypeOptions: [{ key: 'name', display_name: '版本号' }]
    }
  },
  methods: {
    checkPermission,
