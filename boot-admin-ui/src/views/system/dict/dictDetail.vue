    ...
    <div v-else>
      ...
      <div class="head-container">
        <div v-if="crud.props.searchToggle">
          <!-- 搜索 -->
          <el-input v-model="query.label" clearable size="small" placeholder="输入字典标签查询" style="width: 200px;"
...
const defaultForm = { dictId: null, id: null, label: null, value: null, dictSort: 999 }

export default {
  methods: {
    // 新增前合并dictId
    [Crud.HOOK.beforeToAdd]() {
      this.crud.form.dictId = this.dictId
    }
  },
  ...
  cruds() {
    return [
      Crud({
        title: '字典详情', url: 'admin/dictDetail', query: { dictName: '' }, sort: ['id desc'],
