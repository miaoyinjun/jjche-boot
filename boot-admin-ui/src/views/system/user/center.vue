        ...
        <el-card class="box-card">
          ...
          <div>
            <div style="text-align: center">
              <div class="el-upload">
                <img :src="user.avatarName ? '/avatar/' + user.avatarName : Avatar" title="点击上传头像" class="avatar" @click="toggleShow">
                <myUpload
                  v-model="show"
                  :headers="headers"
                  :url="updateAvatarApi"
        ...
        <el-card class="box-card">
          <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-tab-pane label="操作日志" name="second">
              <el-table stripe v-loading="loading" :data="data" style="width: 100%;">
              <el-table-column prop="module" label="模块" />                
                ...
                >
                  <template slot="header">
                    <div style="display:inline-block;float: right;cursor: pointer" @click="init">创建日期<i class="el-icon-refresh" style="margin-left: 30px" /></div>
                  </template>
                  <template slot-scope="scope">
