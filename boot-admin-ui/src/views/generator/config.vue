        ...
        <el-card class="box-card" shadow="never">
          ...
          <el-form ref="form" :model="form" :rules="rules" size="small" label-width="78px">
            ...
            <el-form-item label="接口名称" prop="apiAlias">
              ...
              <span style="color: #C0C0C0;margin-left: 10px;">接口的名称，用于控制器与接口文档中，如：用户</span>
            </el-form-item>
            <el-form-item label="版本号" prop="apiVersion">
              <el-input v-model="form.apiVersion" placeholder="版本号" style="width: 40%" />
              <span style="color: #C0C0C0;margin-left: 10px;">版本号必输，如：1.0.0</span>
            </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      form: { id: null, tableName: '', author: '', pack: '', path: '', moduleName: '', cover: 'false', apiPath: '', prefix: '', apiAlias: null, apiVersion: '' },
      rules: {
        author: [
